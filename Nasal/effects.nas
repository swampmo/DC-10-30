...
if (getprop("sim/aircraft") == "DC-10-30CF")
 ...
 # Close the cargo door if the configuration is set to 'cargo'
 setlistener("sim/model/configuration", func(config)
  {
  if (config.getValue() != "cargo")
   {
   doors.setpos("cargo-main", 0);
   }
  }, 0, 1);
 }
